...
## Project Structure
    ...
    ├── testapiautoconnect_115878  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_115878`
...
2. Clone this repo and `cd testapiautoconnect_115878`
